...
namespace TTW.Combat
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        private void PresetAttack()
        {
            ...
            {
                Vector2Int[] landingCellRelativeTranslator = new Vector2Int[1];

                landingCellRelativeTranslator[0] = selectedAbility.LandingCell;

                combatController.ListOfcells[TranslateRelativeTargetCells(landingCellRelativeTranslator, enemyTarget)[0]].isOccupied = true;
            }
            else
            {
                combatController.ListOfcells[selectedAbility.LandingCell].isOccupied = true;
            }
