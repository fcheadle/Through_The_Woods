...
{
    public enum ActorTargetingType { none, melee, ranged, support, self, cell, allallies, allfoes, supportNotSelf, cardinalAlly, adjacent };
    ...
    public enum ActorAnimationType { none, attackLight, attackMedium, attackHeavy, cast, ranged, block, counter, special1, special2, special3 }
    ...
    public class Ability : ScriptableObject
    {
        ...
        public ActorAnimationType actorAnimation;
        public AbilityEffectHandler abilityEffectHandler;
